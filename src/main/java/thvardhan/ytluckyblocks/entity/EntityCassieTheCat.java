...
public class EntityCassieTheCat extends CreatureEntity {

    private String name = "Cassie The Cat";

    public EntityCassieTheCat(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
