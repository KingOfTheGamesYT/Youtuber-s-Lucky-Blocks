...
public class EntityBabyDuck extends CreatureEntity {

    private String name = "Baby Duck";

    public EntityBabyDuck(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
