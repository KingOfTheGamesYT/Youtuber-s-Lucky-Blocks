...
public class EntityJeromeASF extends CreatureEntity {

    private String name = "JeromeASF";

    public EntityJeromeASF(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
