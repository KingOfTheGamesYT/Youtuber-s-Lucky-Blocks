...
public class EntityAntVenom extends CreatureEntity {

    private String name = "AntVenom";

    public EntityAntVenom(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    ...
    public EntitySize getSize(Pose pose) {
        return EntitySize.flexible(0.8F, 3.1F); // Width and height respectively.
    }
