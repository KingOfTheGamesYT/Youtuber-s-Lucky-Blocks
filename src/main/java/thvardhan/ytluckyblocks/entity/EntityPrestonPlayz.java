...
public class EntityPrestonPlayz extends CreatureEntity {

    private String name = "PrestonPlayz";

    public EntityPrestonPlayz(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
