...
public class EntitySerialPlayer extends CreatureEntity {

    private String name = "thvardhan";

    public EntitySerialPlayer(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
