...
public class EntityStampylonghead extends CreatureEntity {

    private String name = "Stampylonghead";

    public EntityStampylonghead(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    ...
    public static AttributeModifierMap.MutableAttribute getAttributes() {
        return MobEntity.func_233666_p_()
                .createMutableAttribute(Attributes.MAX_HEALTH, 45D)
