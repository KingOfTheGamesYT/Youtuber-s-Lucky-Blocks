...
public class EntityCaptainSparklez extends CreatureEntity {

    private String name = "CaptainSparklez";

    public EntityCaptainSparklez(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
