...
public class EntityPeteZahHutt extends CreatureEntity {

    private String name = "PeteZahHutt";

    public EntityPeteZahHutt(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
