...
public class EntityIhasCupquake extends CreatureEntity {

    private String name = "IhasCupquake";

    public EntityIhasCupquake(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
