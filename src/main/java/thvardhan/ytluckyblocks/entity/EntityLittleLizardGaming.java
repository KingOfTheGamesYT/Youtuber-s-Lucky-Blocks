...
public class EntityLittleLizardGaming extends CreatureEntity {

    private String name = "Littlelizardgaming";

    public EntityLittleLizardGaming(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
