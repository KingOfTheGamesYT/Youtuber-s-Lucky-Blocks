...
public class EntityDanTDM extends CreatureEntity {

    private String name = "DanTDM";

    public EntityDanTDM(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
    ...
    public EntitySize getSize(Pose pose) {
        return EntitySize.flexible(1F, 5F); // Width and height respectively.
    }
    @Override
