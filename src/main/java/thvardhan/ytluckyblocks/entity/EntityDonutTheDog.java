...
public class EntityDonutTheDog extends CreatureEntity {

    private String name = "Donut The Dog";

    public EntityDonutTheDog(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
