...
public class EntitySuperGirlyGamer extends CreatureEntity {

    private String name = "SuperGirlyGamer";

    public EntitySuperGirlyGamer(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
