...
public class EntityTinyTurtle extends CreatureEntity {

    private String name = "Tiny Turtle";

    public EntityTinyTurtle(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
