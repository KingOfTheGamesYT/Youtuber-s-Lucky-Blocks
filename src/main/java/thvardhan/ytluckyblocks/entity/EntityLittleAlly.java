...
public class EntityLittleAlly extends CreatureEntity {

    private String name = "Little Ally";

    public EntityLittleAlly(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
