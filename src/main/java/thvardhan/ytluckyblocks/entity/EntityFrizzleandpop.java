...
public class EntityFrizzleandpop extends CreatureEntity {

    private String name = "Frizzleandpop";

    public EntityFrizzleandpop(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
