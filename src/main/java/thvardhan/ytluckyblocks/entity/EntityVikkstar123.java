...
public class EntityVikkstar123 extends CreatureEntity {

    private String name = "Vikkstar123";

    public EntityVikkstar123(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
