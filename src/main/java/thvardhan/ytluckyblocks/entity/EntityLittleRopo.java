...
public class EntityLittleRopo extends CreatureEntity {

    private String name = "Little Ropo";

    public EntityLittleRopo(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
