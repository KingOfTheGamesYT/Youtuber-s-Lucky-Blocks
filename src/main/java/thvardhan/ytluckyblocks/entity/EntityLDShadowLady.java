...
public class EntityLDShadowLady extends CreatureEntity {

    private String name = "LDShadowLady";

    public EntityLDShadowLady(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
