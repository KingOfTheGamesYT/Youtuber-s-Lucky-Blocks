...
public class EntityISquid extends CreatureEntity {

    private String name = "IBallisticSquid";

        public EntityISquid(EntityType<? extends CreatureEntity> type, World worldIn) {
            super(type, worldIn);
