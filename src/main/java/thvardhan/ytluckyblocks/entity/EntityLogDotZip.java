...
public class EntityLogDotZip extends MonsterEntity {
    ...
    public EntityLogDotZip(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        ((PathNavigator) this.getNavigator()).setCanSwim(true);
        this.setCustomName(new StringTextComponent(name));
        this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(RegistrationHandler.MASTER_SWORD.get()));
    }
