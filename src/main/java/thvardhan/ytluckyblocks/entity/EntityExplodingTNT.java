...
public class EntityExplodingTNT extends CreatureEntity {

    private String name = "ExplodingTNT";

    public EntityExplodingTNT(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
