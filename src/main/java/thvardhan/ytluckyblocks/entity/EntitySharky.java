...
public class EntitySharky extends CreatureEntity {

    private String name = "Sharky Lucky";

    public EntitySharky(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
