...
public class EntityBabyMax extends CreatureEntity {

    private String name = "Baby Max";

    public EntityBabyMax(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
