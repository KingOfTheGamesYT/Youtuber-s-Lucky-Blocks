...
public class EntityPinkSheep extends CreatureEntity {

    private String name = "PinkSheepYT";

    public EntityPinkSheep(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
