...
public class EntityLittleDonny extends CreatureEntity {

    private String name = "Little Donny";

    public EntityLittleDonny(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
