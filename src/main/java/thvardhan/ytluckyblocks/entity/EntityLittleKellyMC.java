...
public class EntityLittleKellyMC extends CreatureEntity {

    private String name = "Little Kelly Minecraft";

    public EntityLittleKellyMC(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
