...
public class EntityMrWoofless extends CreatureEntity {

    private String name = "MrWoofless";

    public EntityMrWoofless(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
