...
public class EntityEvilLittleKelly extends CreatureEntity {

    private String name = "Evil Little Kelly";

    public EntityEvilLittleKelly(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
