...
public class EntityMrCrainer extends CreatureEntity {

    private String name = "MrCrainer";

    public EntityMrCrainer(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
