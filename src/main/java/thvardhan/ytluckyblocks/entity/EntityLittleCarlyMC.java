...
public class EntityLittleCarlyMC extends CreatureEntity {

    private String name = "Little Carly";

    public EntityLittleCarlyMC(EntityType<? extends CreatureEntity> type, World worldIn) {
        super(type, worldIn);
