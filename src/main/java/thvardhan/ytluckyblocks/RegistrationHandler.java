...
public class RegistrationHandler {
    ...
    public static final RegistryObject<Item> YT_BOOTS = ITEMS.register("yt_boots", () -> new ItemModArmor( YOUTUBE, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> YT_LEGS = ITEMS.register("yt_leggings", () -> new ItemModArmor( YOUTUBE, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LEAH_HELM = ITEMS.register("leahhelmet", () -> new ItemModArmor( LEAH, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LEAH_CHEST = ITEMS.register("leahchestplate", () -> new ItemModArmor( LEAH, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LEAH_BOOTS = ITEMS.register("leahboots", () -> new ItemModArmor( LEAH, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LEAH_LEGS = ITEMS.register("leahleggings", () -> new ItemModArmor( LEAH, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DUCK_HELM = ITEMS.register("duckhelmet", () -> new ItemModArmor( DUCK, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DUCK_CHEST = ITEMS.register("duckchestplate", () -> new ItemModArmor( DUCK, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DUCK_BOOTS = ITEMS.register("duckboots", () -> new ItemModArmor( DUCK, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DUCK_LEGS = ITEMS.register("duckleggings", () -> new ItemModArmor( DUCK, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    ...
    public static final RegistryObject<Item> MAX_CHEST = ITEMS.register("maxchestplate", () -> new ItemModArmor( MAX, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MAX_BOOTS = ITEMS.register("maxboots", () -> new ItemModArmor( MAX, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MAX_LEGS = ITEMS.register("maxleggings", () -> new ItemModArmor( MAX, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CASSIE_THE_CAT_HELM = ITEMS.register("cassiethecathelmet", () -> new ItemModArmor( CASSIETHECAT, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CASSIE_THE_CAT_CHEST = ITEMS.register("cassiethecatchestplate", () -> new ItemModArmor( CASSIETHECAT, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CASSIE_THE_CAT_BOOTS = ITEMS.register("cassiethecatboots", () -> new ItemModArmor( CASSIETHECAT, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CASSIE_THE_CAT_LEGS = ITEMS.register("cassiethecatleggings", () -> new ItemModArmor( CASSIETHECAT, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONUT_HELM = ITEMS.register("donuthelmet", () -> new ItemModArmor( DONUT, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONUT_CHEST = ITEMS.register("donutchestplate", () -> new ItemModArmor( DONUT, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONUT_BOOTS = ITEMS.register("donutboots", () -> new ItemModArmor( DONUT, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONUT_LEGS = ITEMS.register("donutleggings", () -> new ItemModArmor( DONUT, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> EVILLITTLEKELLY_HELM = ITEMS.register("evillittlekellyhelmet", () -> new ItemModArmor( EVILLITTLEKELLY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> EVILLITTLEKELLY_CHEST = ITEMS.register("evillittlekellychestplate", () -> new ItemModArmor( EVILLITTLEKELLY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> EVILLITTLEKELLY_BOOTS = ITEMS.register("evillittlekellyboots", () -> new ItemModArmor( EVILLITTLEKELLY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> EVILLITTLEKELLYLEGS = ITEMS.register("evillittlekellyleggings", () -> new ItemModArmor( EVILLITTLEKELLY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> ALLY_HELM = ITEMS.register("allyhelmet", () -> new ItemModArmor( LITTLE_ALLY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> ALLY_CHEST = ITEMS.register("allychestplate", () -> new ItemModArmor( LITTLE_ALLY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> ALLY_BOOTS = ITEMS.register("allyboots", () -> new ItemModArmor( LITTLE_ALLY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> ALLY_LEGS = ITEMS.register("allyleggings", () -> new ItemModArmor( LITTLE_ALLY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CARLY_HELM = ITEMS.register("carlyhelmet", () -> new ItemModArmor( LITTLECARLY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CARLY_CHEST = ITEMS.register("carlychestplate", () -> new ItemModArmor( LITTLECARLY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CARLY_BOOTS = ITEMS.register("carlyboots", () -> new ItemModArmor( LITTLECARLY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> CARLY_LEGS = ITEMS.register("carlyleggings", () -> new ItemModArmor( LITTLECARLY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONNY_HELM = ITEMS.register("donnyhelmet", () -> new ItemModArmor( LITTLE_DONNY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONNY_CHEST = ITEMS.register("donnychestplate", () -> new ItemModArmor( LITTLE_DONNY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONNY_BOOTS = ITEMS.register("donnyboots", () -> new ItemModArmor( LITTLE_DONNY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> DONNY_LEGS = ITEMS.register("donnyleggings", () -> new ItemModArmor( LITTLE_DONNY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLEKELLY_HELM = ITEMS.register("littlekellyhelmet", () -> new ItemModArmor( LITTLEKELLY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLEKELLY_CHEST = ITEMS.register("littlekellychestplate", () -> new ItemModArmor( LITTLEKELLY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLEKELLY_BOOTS = ITEMS.register("littlekellyboots", () -> new ItemModArmor( LITTLEKELLY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLEKELLY_LEGS = ITEMS.register("littlekellyleggings", () -> new ItemModArmor( LITTLEKELLY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLELIZARD_HELM = ITEMS.register("littlelizardhelmet", () -> new ItemModArmor( LITTLE_LIZARDGAMING, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLELIZARD_CHEST = ITEMS.register("littlelizardchestplate", () -> new ItemModArmor( LITTLE_LIZARDGAMING, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLELIZARD_BOOTS = ITEMS.register("littlelizardboots", () -> new ItemModArmor( LITTLE_LIZARDGAMING, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> LITTLELIZARD_LEGS = ITEMS.register("littlelizardleggings", () -> new ItemModArmor( LITTLE_LIZARDGAMING, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MONKEY_HELM = ITEMS.register("monkeyhelmet", () -> new ItemModArmor( MAX_THEMONKEY, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MONKEY_CHEST = ITEMS.register("monkeychestplate", () -> new ItemModArmor( MAX_THEMONKEY, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MONKEY_BOOTS = ITEMS.register("monkeyboots", () -> new ItemModArmor( MAX_THEMONKEY, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> MONKEY_LEGS = ITEMS.register("monkeyleggings", () -> new ItemModArmor( MAX_THEMONKEY, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> SHARKY_HELM = ITEMS.register("sharkyhelmet", () -> new ItemModArmor( SHARK_Y, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> SHARKY_CHEST = ITEMS.register("sharkychestplate", () -> new ItemModArmor( SHARK_Y, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> SHARKY_BOOTS = ITEMS.register("sharkyboots", () -> new ItemModArmor( SHARK_Y, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> SHARKY_LEGS = ITEMS.register("sharkyleggings", () -> new ItemModArmor( SHARK_Y, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> TURTLE_HELM = ITEMS.register("turtlehelmet", () -> new ItemModArmor( TINY_TURTLE, EquipmentSlotType.HEAD, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> TURTLE_CHEST = ITEMS.register("turtlechestplate", () -> new ItemModArmor( TINY_TURTLE, EquipmentSlotType.CHEST, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> TURTLE_BOOTS = ITEMS.register("turtleboots", () -> new ItemModArmor( TINY_TURTLE, EquipmentSlotType.FEET, new Item.Properties().group(Main.MAIN)));
    public static final RegistryObject<Item> TURTLE_LEGS = ITEMS.register("turtleleggings", () -> new ItemModArmor( TINY_TURTLE, EquipmentSlotType.LEGS, new Item.Properties().group(Main.MAIN)));
